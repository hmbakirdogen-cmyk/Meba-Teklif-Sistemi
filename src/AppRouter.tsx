...
const MalzemeGecmisiSayfasi = lazy(() => import('./pages/MalzemeGecmisiSayfasi'));
    ...
    <>
      <Routes>
        ...
        <Route element={<AppLayout />}>
          ...
          <Route path="/malzeme-gecmisi" element={<Suspense fallback={<PageFallback />}><MalzemeGecmisiSayfasi /></Suspense>} />

          ...
          <tr>
            ...
            <td style={{ padding: '0', borderTop: 'none', borderBottom: 'none', verticalAlign: 'top' }}>
              <TotalsCard
                ...
                animate={!readOnly || !!kismiOnaySecim}
              />
              <KargoNotuSatiri
              ...
              <div style={{ display: 'flex', flexWrap: 'nowrap', justifyContent: kullanilanParaKartlari.length >= 3 ? 'flex-start' : 'flex-end', alignItems: 'flex-start', gap: '10px' }}>
                ...
                {kullanilanParaKartlari.map((item) => (
                  <div key={item.pb} style={{ width: '220px', minWidth: '220px', flexShrink: 0 }}>
                    <TotalsCard araToplam={item.araToplam} iskontoOrani={iskontoOrani} iskontoTutar={item.iskontoTutar} kdvOrani={kdvOrani} kdvTutar={item.kdvTutar} genelToplam={item.total} paraBirimi={item.pb} variant="light" animate={!readOnly || !!kismiOnaySecim} />
                  </div>
                ))}
              </div>
              <KargoNotuSatiri

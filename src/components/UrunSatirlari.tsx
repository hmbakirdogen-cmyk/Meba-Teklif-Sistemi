    ...
    // ── Marka ────────────────────────────────────────────────────
    {
      ...
      render: (_: unknown, satir: TeklifSatiri) => (
        <>
          <input
            type="text"
            list={`marka-list-${satir.id}`}
            value={satir.marka}
            placeholder="—"
            onChange={(e) => guncelle(satir.id, 'marka', e.target.value)}
            ...
            style={cellInput}
          />
          <datalist id={`marka-list-${satir.id}`}>
    ...
    // ── Açıklama ─────────────────────────────────────────────────
    {
      ...
      render: (_: unknown, satir: TeklifSatiri) => (
        <Input
          ...
          placeholder="—"
          style={{ fontSize: 12, height: 26, borderColor: '#d1d9e6' }}
        />
      ),
    },
    // ── Miktar / Birim ───────────────────────────────────────────
